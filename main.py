...
# Se estiver na raiz do projeto e main.py estiver em uma subpasta, você pode precisar ajustar o path
...
# Importa os modelos depois que o Django foi configurado
